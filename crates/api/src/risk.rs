...
pub mod risk_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn check_risk(
            ...
            tonic::Response<super::CheckRiskResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("risk.RiskService", "CheckRisk"));
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/risk.RiskService/CheckRisk" => {
                    ...
                    impl<
                        T: RiskService,
                    > tonic::server::UnaryService<super::CheckRiskRequest>
                    for CheckRiskSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as RiskService>::check_risk(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
