...
use crate::models::auth::{AuthContext, JwtClaims, UserSession, ApiKey};
use crate::repository::auth_repo::AuthRepository;
use api::auth::auth_service_server::AuthService as AuthGrpcService;
use api::auth::*;

// Re-export the generated types
pub use api::auth::auth_service_server::AuthServiceServer;
...
#[tonic::async_trait]
impl AuthGrpcService for AuthServiceImpl {
