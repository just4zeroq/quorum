...
pub struct CancelRequest {
    #[prost(bytes = "vec", tag = "1")]
    pub cancel_data: ::prost::alloc::vec::Vec<u8>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct OrderBookResponse {
    ...
    pub message: ::prost::alloc::string::String,
    #[prost(bytes = "vec", tag = "3")]
    pub orderbook_data: ::prost::alloc::vec::Vec<u8>,
}
...
pub mod matching_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> MatchingServiceClient<InterceptedService<T, F>>
        where
        ...
        {
            MatchingServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        pub async fn submit_order(
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("matching.MatchingService", "SubmitOrder"));
        ...
        pub async fn cancel_order(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("matching.MatchingService", "CancelOrder"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("matching.MatchingService", "GetOrderBook"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod matching_service_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with MatchingServiceServer.
    #[async_trait]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/matching.MatchingService/SubmitOrder" => {
                    ...
                    impl<
                        T: MatchingService,
                    > tonic::server::UnaryService<super::OrderCommandRequest>
                    for SubmitOrderSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as MatchingService>::submit_order(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/matching.MatchingService/CancelOrder" => {
                    ...
                    for CancelOrderSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MatchingService>::cancel_order(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/matching.MatchingService/GetOrderBook" => {
                    ...
                    for GetOrderBookSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MatchingService>::get_order_book(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
